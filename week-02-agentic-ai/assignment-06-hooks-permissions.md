...
![screenshot5c](screenshots/hooks-folder.png)
...
![screenshot2](screenshots/user-prompt-guard.png)
...
![screenshot3](screenshots/pre-tool-guard.png)
...
![screenshot4](screenshots/post-tool-logger.png)
...
![screenshot5](screenshots/settings-json.png)
...
![screenshot6](screenshots/userpromptsubmit-hook-block.png)
---
...
![screenshot7](screenshots/pretooluse-hook-block.png)
...
![screenshot8](screenshots/claude-terraform-validate-success.png)

#### Screenshot 9 — `.claude/deploy.log` showing the logged command

![screenshot9](screenshots/deploy-loggged-command.png)
